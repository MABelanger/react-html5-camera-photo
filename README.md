...
**isDisplayStartCameraError:** (Optional) | Boolean | If is true, if the camera start with error, it will show the error between <h1></h1> tag on the top of the component. Useful to notify the user about permission error, the default is true.
